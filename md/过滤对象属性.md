...
![1601456694726](%E8%BF%87%E6%BB%A4%E5%AF%B9%E8%B1%A1%E5%B1%9E%E6%80%A7.assets/1601456694726.png)

当前方法，其实并不太灵活，`ignorableFieldNames`并不能被动态传递；

### 3、总结

未完待续，2.4的自定义方法并非很好，最好的应该是可以在`Controller`方法上直接添加自定义的注解，比如`@JsonFilter(type=Test.class, value={"name", "subName"})`, 后续继续探讨这个方法，码字不易，不喜勿喷。
