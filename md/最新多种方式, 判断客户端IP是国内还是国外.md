...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/843d69e58f444d58a1e23edd3e4ad6cd~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0672da6c95114fb694f01a78a6d9a006~tplv-k3u1fbpfcp-zoom-1.image)
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8f716a60d025489b87e4e171785738d9~tplv-k3u1fbpfcp-zoom-1.image)
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3fee7adc458746268a34b992dfdeb4ba~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1625e6440da54aaf8d4d1e6265ee7190~tplv-k3u1fbpfcp-zoom-1.image)

通过这个`javascript API`，就可以判断当前IP是否是国内外，因为我开代理测试的，所以显示当前IP是新加坡。

`MaxMind`的其他实现方式，有的是需要付费，按次收费，获取到的数据也会更加详细更加准确。

==最新提示：目前这个不是免费的，外网IP下无权限，需要付费。==
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/291c05e201a549adaef5a715c271ff86~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/83f5ba461fd94c388e002d35612772c6~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7b38c785b38e4fdfbd112328ca724ce4~tplv-k3u1fbpfcp-zoom-1.image)
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b1dee2aadd7148ecb38610b482f54d97~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0d6f31f4ce4d457f80d8b0348190d704~tplv-k3u1fbpfcp-zoom-1.image)

在IP库中：

比如`222.126.128.0/15`对应的文本应该是`apnic|CN|ipv4|222.126.128.0|32768|20060830|allocated`中的`222.126.128.0|32768`;

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/30fb1945454c455c8d9fd6e5dd36aba1~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aa6a36be36ca498ab00f2686a39154b9~tplv-k3u1fbpfcp-zoom-1.image)
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2029204becdc4ca29e617a3b660715d5~tplv-k3u1fbpfcp-zoom-1.image)
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a28d3b69c8bc41f6bdbc7ed7dfd44362~tplv-k3u1fbpfcp-zoom-1.image)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1669c08a6e33465cb1e64c1b739be07e~tplv-k3u1fbpfcp-zoom-1.image)

#### 2.3、ip2region

数据库是==ip2region.db==，放到静态资源目录下
